  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="mt-1 text-sm text-gray-600">
            Manage your AWS EKS configurations and settings
          </p>
        </div>
        <Link to="/aws-eks/create" className="btn-primary flex items-center">
      ...
      <div className="card p-8 text-center">
        ...
        <h3 className="mt-4 text-lg font-medium text-gray-900">AWS EKS Configuration</h3>
