  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="mt-1 text-sm text-gray-600">
            Manage your GitLab account credentials and settings
          </p>
        </div>
        <Link to="/gitlab/create" className="btn-primary flex items-center">
      ...
      <div className="card p-8 text-center">
        ...
        <h3 className="mt-4 text-lg font-medium text-gray-900">GitLab Configuration</h3>
